...
//É necessario fazer a conexão com Banco de Dados
require_once "configDB.php";

function verificar_entrada($entrada){
    $saida = trim($entrada);//Remove espaços antes e depos
...
if($senha != $senhaC){
    ...
    echo "<h1>Esta Página não pode ser acessada diretamente</h1>";
}
